...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand-lg navbar-light bg-primary border-bottom">
    ...
    <ul class="navbar-nav">
      ...
      <a class="nav-link dropdown-toggle"  id="navbarDropdown" role="button" 
        ...
        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right"  style="color : #000000;">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index3.html" class="brand-link">
      <img src="{{asset('/homepage/dist/img/AdminLTELogo.png')}}" alt="AdminLTE Logo" class="brand-image img-circle elevation-3"
           style="opacity: .8">
