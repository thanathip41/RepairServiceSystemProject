        ...
        <button type="button" class="close text-white" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
	      ...
	      <div class="modal-body">
				...
				<label class="btn btn-success" style="margin-left:3%">
					<input type="radio"  name="status_id" value="4" required autocomplete="off">ยืนยัน (กรณีเสร็จสมบูรณ์)<br>
					</label>
				<label class="btn btn-danger ">
					<input type="radio"  name="status_id" value="5" required autocomplete="off">ปฏิเสธ (กรณีไม่สามารถใช้งานได้)<br>
					</label>
